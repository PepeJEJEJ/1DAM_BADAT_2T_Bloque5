...
-- 18. Nombre del jugador, nombre del equipo y su posición. (duplicado del 8)
select j.nombre, e.nombre, j.posicion FROM jugador j JOIN equipo e ON e.id_equipo = j.equipo;
